...
curl -L -X PUT https://$REGISTRY_URL/v1/$MODULE_NAME/$VERSION/upload --data-binary "@$DIR/$VERSION.tar.gz" -H "Content-Type: application/x-tar" -H "Authorization: Bearer $API_TOKEN"
