...
def provider_mirror_index(event: HttpEvent, hostname: str, namespace: str, type: str) -> Response:
...
def provider_mirror_packages(event: HttpEvent, hostname: str, namespace: str, type: str, version: str) -> Response:
